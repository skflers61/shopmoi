...
--
-- Client: localhost
-- Généré le: Ven 29 Avril 2016 à 11:25
...
--
CREATE DATABASE IF NOT EXISTS `shopmoi` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `shopmoi`;
...
(3, 4, 'bundles/smsite/images/article3/3.jpg', '231x383', 'Winter Knit Zip Hoodie', ''),
(4, 7, 'bundles/smsite/images/article4/4.jpg', '231x383', 'Hooded Checked Flannel', ''),
(5, 8, 'bundles/smsite/images/article5/5.jpg', '231x383', 'Stripe Jersey Hoodie', ''),
