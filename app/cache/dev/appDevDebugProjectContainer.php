...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'shopmoi', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\SM\\SiteBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\SM\\UserBundle\\Entity')));
        ...
        $d->addDriver($b, 'SM\\SiteBundle\\Entity');
        $d->addDriver($b, 'SM\\UserBundle\\Entity');
        $d->addDriver($c, 'FOS\\UserBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('SMSiteBundle' => 'SM\\SiteBundle\\Entity', 'SMUserBundle' => 'SM\\UserBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f40b6fe2a3bc5f0fa78fc1aff1ea30f0d4070fe6ce576253454be45bcd47e083');
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('SM\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('SM\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'SM\\UserBundle\\Entity\\User');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\SM\\SiteBundle/Resources/views'), 'SMSite');
        $instance->addPath(($this->targetDirs[3].'\\src\\SM\\FemmesBundle/Resources/views'), 'SMFemmes');
        $instance->addPath(($this->targetDirs[3].'\\src\\SM\\HommesBundle/Resources/views'), 'SMHommes');
        $instance->addPath(($this->targetDirs[3].'\\src\\SM\\EnfantsBundle/Resources/views'), 'SMEnfants');
        $instance->addPath(($this->targetDirs[3].'\\src\\SM\\UserBundle/Resources/views'), 'SMUser');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SMHommesBundle' => 'SM\\HommesBundle\\SMHommesBundle',
                'SMEnfantsBundle' => 'SM\\EnfantsBundle\\SMEnfantsBundle',
                'SMUserBundle' => 'SM\\UserBundle\\SMUserBundle',
            ...
            'fos_user.model.user.class' => 'SM\\UserBundle\\Entity\\User',
